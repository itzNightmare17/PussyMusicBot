...
from PussyMusic import app
from PussyMusic.core.call import Pussy
from PussyMusic.misc import db
from PussyMusic.utils.database import get_authuser_names, get_cmode
from PussyMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from PussyMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Pussy.stop_stream(message.chat.id)
    except:
        pass
